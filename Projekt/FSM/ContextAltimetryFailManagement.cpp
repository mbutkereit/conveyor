...
ContextAltimetryFailManagement::ContextAltimetryFailManagement(ContextTimeout* cto1, ContextTimeout* cto2, ContextTimeout* cto3) :
			statePtr(&stateMember), cafm(cto1,cto2,cto3) // assigning start state
	{
		statePtr->data = &cafm;
	}
