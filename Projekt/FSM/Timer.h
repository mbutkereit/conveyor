...
#define SECONDS_SLOW 1
#define NSECONDS_SLOW 1
#define INTERVAL_SECONDS_SLOW 1
#define INTERVAL_NSECONDS_SLOW 1

#define SECONDS_FAST 1
#define NSECONDS_FAST 1
#define INTERVAL_SECONDS_FAST 1
#define INTERVAL_NSECONDS_FAST 1
