...
ContextConveyor2::ContextConveyor2(int puckID, std::vector<Puck>* puckVector, int *skidcounter2): statePtr(&stateMember), contextdata(puckID, puckVector,skidcounter2)  {
